      ...
      {member.deposit && member.deposit > 0 && (
        <div className="flex gap-2">
          <button
            ...
            className="flex-1 rounded-lg bg-blue-500 py-2.5 text-xs font-semibold text-white hover:bg-blue-600"
          >
            Rembourser (geste)
          </button>
          <button
            onClick={onGarder}
            className="flex-1 rounded-lg bg-red-500 py-2.5 text-xs font-semibold text-white hover:bg-red-600"
          >
            Frais retenus
          </button>
        </div>
