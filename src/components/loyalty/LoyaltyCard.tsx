          ...
          <div className="flex items-start gap-3">
            <div className="flex-1 min-w-0">
              ...
              <p className="text-[10px] text-slate-600 mt-1.5">
                {rdv} / {nextTier.rdv} RDV honorés
              </p>
            </div>
            <button
              onClick={() => setShowModal(true)}
              className="shrink-0 w-8 h-8 rounded-full bg-white/10 border border-white/10 flex items-center justify-center text-slate-400 hover:text-white hover:bg-white/15 transition-colors text-xs font-bold"
            >
              ⓘ
            </button>
          </div>
